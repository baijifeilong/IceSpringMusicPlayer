...
class PlaylistTable(IceTableView, ReplacerMixin):
    ...
    def __init__(self, parent: QtWidgets.QWidget) -> None:
        ...
        self.setColumnWidth(0, int(35 * self._config.zoom))
        self.setColumnWidth(1, int(150 * self._config.zoom))
        self.doubleClicked.connect(self._onDoubleClicked)
        self.setIconSize(QtCore.QSize(32, 32) * self._config.zoom)
    ...
    def _onMusicsInserted(self, indexes: typing.List[int]):
        ...
        self._config.zoom < 0.8 and self.resizeRowsToContents()
