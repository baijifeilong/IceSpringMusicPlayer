...
MaskWidget_HorizontallySplitBy = Text()
MaskWidget_HorizontallySplitBy.en_US = "Horizontally Split By"
MaskWidget_VerticallySplitBy = Text()
MaskWidget_VerticallySplitBy.en_US = "Vertically Split By"
